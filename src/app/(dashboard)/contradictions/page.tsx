...
import { AlertTriangle, Search, Loader2, ShieldAlert, ChevronRight } from "lucide-react";
    ...
    <PageContainer>
      <Stack gap={6}>
        <div className="flex flex-col gap-2">
          <h1 className="text-foreground text-2xl font-bold tracking-tight">Contradictions</h1>
        ...
        {summary && (
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div className="border-border bg-background rounded-lg border p-4">
              ...
              <p className="text-destructive text-2xl font-bold">{summary.criticalCount}</p>
            </div>
            <div className="border-border bg-background rounded-lg border p-4">
              <span className="text-muted-foreground text-xs font-medium">Unresolved</span>
              <p className="text-warning text-2xl font-bold">{summary.unresolvedCount}</p>
            </div>
            <div className="border-border bg-background rounded-lg border p-4">
              <span className="text-muted-foreground text-xs font-medium">Resolved</span>
              <p className="text-success text-2xl font-bold">{summary.byStatus["RESOLVED"] ?? 0}</p>
            </div>
          </div>
        )}
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-foreground text-lg font-medium">No contradictions detected</p>
                ...
                >
                  <div
                    className={cn(
                      ...
                      SEVERITY_COLORS[c.severity] ?? SEVERITY_COLORS["NEEDS_REVIEW"],
                    )}
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={cn(
                          ...
                          STATUS_COLORS[c.status] ?? STATUS_COLORS["DETECTED"],
                        )}
                      >
