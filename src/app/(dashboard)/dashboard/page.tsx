      ...
      <Stack gap={8}>
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted-foreground">
            Engineering reality at a glance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {QUICK_ACTIONS.map((action) => (
            <Link
              ...
              href={action.href}
              className={cn(
                "group flex items-center gap-3 rounded-lg border border-border bg-background p-4",
                ...
                <Stack gap={0}>
                  {recentDocuments.map((doc) => (
                    <Link
                      ...
                      className="flex items-center gap-3 border-b border-border p-4 transition-colors last:border-b-0 hover:bg-surface-hover"
                    >
