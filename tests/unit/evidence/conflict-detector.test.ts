...
describe("conflict-detector", () => {
  ...
  it("detects conflicting specifications with different statuses", () => {
    const nodes = [
      makeNode({ id: "target", label: "Component", entityType: "COMPONENT", entityId: "ent-1" }),
      makeNode({ id: "spec1", label: "Spec A", entityType: "SPECIFICATION", type: "SPECIFICATION", status: "ACTIVE" }),
      makeNode({ id: "spec2", label: "Spec B", entityType: "SPECIFICATION", type: "SPECIFICATION", status: "DRAFT" }),
    ];
    const edges: EvidenceEdge[] = [
  ...
  it("does not flag specifications with same status as conflicting", () => {
    const nodes = [
      makeNode({ id: "target", label: "Component", entityType: "COMPONENT", entityId: "ent-1" }),
      makeNode({ id: "spec1", label: "Spec A", type: "SPECIFICATION", entityType: "SPECIFICATION", status: "ACTIVE" }),
      makeNode({ id: "spec2", label: "Spec B", type: "SPECIFICATION", entityType: "SPECIFICATION", status: "ACTIVE" }),
    ];
    const edges: EvidenceEdge[] = [
      { id: "e1", sourceId: "spec1", targetId: "target", relationType: "REFERENCES" },
      { id: "e2", sourceId: "spec2", targetId: "target", relationType: "REFERENCES" },
